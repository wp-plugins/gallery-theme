...
*** If you choose your gallery theme file name like this: 'gallery-theme-default.php' and place it in your main template folder (in the root) or plugin's 'themes' folder, wordpress galleries will use this theme as default theme instead of wordpress's internal gallery theme.<br />
